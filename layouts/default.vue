...
<template>
    <div class="flex flex-col min-h-screen">
                ...
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div class="flex flex-shrink-0 items-center">
                            <p class="font-bold text-white">Nanda Ninja</p>
                        </div>
        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 grow items-start w-full">
            <slot />
        </div>

        <footer class="bg-gray-800">
            <section class="mx-auto max-w-7xl px-2 sm:px-4 lg:py-6 text-gray-300 flex flex-row">
                <p class="flex-1">Nanda H. Marfianshar 2023. All Rights Reserved</p>
                <!-- TODO(nanda): icon media social -->
            </section>
        </footer>
    </div>
</template>